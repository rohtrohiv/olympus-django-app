...
class CardTransactions(models.Model):
	"""Unmanaged model for web_ai.card_transactions materialized view."""
	cardholder = models.TextField(blank=True, null=True)
	merchant = models.TextField(blank=True, null=True)
	transaction_date_clean = models.DateField(blank=True, null=True)
	transaction_id = models.CharField(max_length=50, blank=True, null=True)
	transaction_date = models.DateField(blank=True, null=True)
	post_date = models.DateField(blank=True, null=True)
	transaction_amount = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	merchant_surcharge = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	account_number = models.CharField(max_length=50, blank=True, null=True)
	cardholder_last_name = models.CharField(max_length=100, blank=True, null=True)
	cardholder_first_name = models.CharField(max_length=100, blank=True, null=True)
	cardholder_middle_initial = models.CharField(max_length=10, blank=True, null=True)
	central_bill_account = models.CharField(max_length=50, blank=True, null=True)
	billed_to_account = models.CharField(max_length=50, blank=True, null=True)
	diversion_account = models.CharField(max_length=50, blank=True, null=True)
	parent_merchant_name = models.CharField(max_length=255, blank=True, null=True)
	merchant_name = models.CharField(max_length=255, blank=True, null=True)
	original_merchant_name = models.CharField(max_length=255, blank=True, null=True)
	mcc = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	mcc_description = models.CharField(max_length=255, blank=True, null=True)
	merchant_type = models.CharField(max_length=50, blank=True, null=True)
	merchant_address_1 = models.CharField(max_length=255, blank=True, null=True)
	merchant_address_2 = models.CharField(max_length=255, blank=True, null=True)
	merchant_city = models.CharField(max_length=100, blank=True, null=True)
	merchant_state_province = models.CharField(max_length=100, blank=True, null=True)
	merchant_country = models.CharField(max_length=100, blank=True, null=True)
	merchant_postal_code = models.CharField(max_length=20, blank=True, null=True)
	transaction_code = models.CharField(max_length=50, blank=True, null=True)
	transaction_code_reason_code = models.CharField(max_length=50, blank=True, null=True)
	sales_tax = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	settled_currency = models.CharField(max_length=10, blank=True, null=True)
	original_currency = models.CharField(max_length=10, blank=True, null=True)
	original_amount = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	...
	item_unit_price_amount = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	item_quantity = models.IntegerField(blank=True, null=True)
	item_detail_tax_amount = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	line_item_total = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
	chart_of_accounts = models.CharField(max_length=100, blank=True, null=True)
	indicator_1099 = models.CharField(max_length=10, blank=True, null=True)
	socio_economic_indicator_1 = models.CharField(max_length=50, blank=True, null=True)
	socio_economic_indicator_2 = models.CharField(max_length=50, blank=True, null=True)
	coa_segment_value_1 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_2 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_3 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_4 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_5 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_6 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_7 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_8 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_9 = models.CharField(max_length=100, blank=True, null=True)
	coa_segment_value_10 = models.CharField(max_length=100, blank=True, null=True)
	hierarchy_id = models.CharField(max_length=50, blank=True, null=True)
	hierarchy_description = models.CharField(max_length=255, blank=True, null=True)
	reference_number = models.CharField(max_length=100, blank=True, null=True)
	transaction_convenience_check_number = models.CharField(max_length=50, blank=True, null=True)
	transaction_authorization_number = models.CharField(max_length=50, blank=True, null=True)
	...
	dispute_indicator = models.CharField(max_length=10, blank=True, null=True)
	dispute_status = models.CharField(max_length=50, blank=True, null=True)
	transaction_export_status_code = models.CharField(max_length=50, blank=True, null=True)
	transaction_approval_status = models.CharField(max_length=50, blank=True, null=True)
	approval_indicator_1 = models.CharField(max_length=10, blank=True, null=True)
	transaction_approver_name_1 = models.CharField(max_length=100, blank=True, null=True)
	approval_indicator_2 = models.CharField(max_length=10, blank=True, null=True)
	transaction_approver_name_2 = models.CharField(max_length=100, blank=True, null=True)
	approval_indicator_3 = models.CharField(max_length=10, blank=True, null=True)
	transaction_approver_name_3 = models.CharField(max_length=100, blank=True, null=True)
	approval_indicator_4 = models.CharField(max_length=10, blank=True, null=True)
	transaction_approver_name_4 = models.CharField(max_length=100, blank=True, null=True)
	approval_indicator_5 = models.CharField(max_length=10, blank=True, null=True)
	transaction_approver_name_5 = models.CharField(max_length=100, blank=True, null=True)
	custom_field_value_1 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_2 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_3 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_4 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_5 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_6 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_7 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_8 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_9 = models.CharField(max_length=255, blank=True, null=True)
	custom_field_value_10 = models.CharField(max_length=255, blank=True, null=True)
	transaction_notes = models.CharField(max_length=1000, blank=True, null=True)
	...
	row_hash_key = models.CharField(max_length=1000, primary_key=True)
	insert_timestamp = models.DateTimeField(blank=True, null=True)

	class Meta:
		managed = False
		db_table = '"web_ai"."card_transactions"'
